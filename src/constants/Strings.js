export const ValidationMessages = {
  ...
  PLEASE_ENTER_CURR_PASS: 'Please enter your current password.',
  PLEASE_ENTER_NEW_PASS: 'Please enter a new password.',
  PLEASE_ENTER_CONFIRM_PASS: 'Please enter the password again to confirm.',
  ALL_MANDATORY:
    'Please ensure you have provided all the required information..',
  INVALID_MOBILE: 'Please enter a valid mobile number.',
  PICTURE_REQUIRE: 'Please ensure you upload a display picture to proceed.',
  TERMS_CONDITIONS:
    'Please be sure to read and accept the Terms & Conditions and Privacy Policy before proceeding.',
  ...
  CONFIRM_PASSWORD: 'Please enter the password again to confirm.',
  ...
  UNMATCHED_PASS: 'Password mis-match.',
  ...
  SELECT_HAIR_PRE: 'Please select your hair color preference.',
  SELECT_EYE: 'Please select your eye color.',
  SELECT_EYE_PRE: 'Please select your eye color preference.',
  SELECT_HEIGHT: 'Please select your height.',
  SELECT_AGE_PRE: 'Please select your age range preference.',
  SELECT_MIN_QUAL: 'Please select your hightest education qualification.',
  ...
  LOCATION_PREF: 'Please select your location preference.',
  LOCATION: 'Please select your location preference.',
  MAX_FIRST_NAME: 'Please enter a first name with a maximum of 30 characters.',
  MAX_MIDDLE_NAME:
    'Please enter a middle name with a maximum of 30 characters.',
  MAX_LAST_NAME: 'Please enter a last name with a maximum of 30 characters.',
  Education: 'Please select your highest education qualification.',
  EducationPRE: 'Please select the minimum educational qualification.',
  MAX_ZIP: 'Please enter a valid 5 digit ZIP code.',
  MIN_ZIP: 'Please enter a valid 5 digit ZIP code.',
  SELECT_RACE: 'Please select your race.',
  SELECT_MOT_ETHNICITY: "Please select your mother's ethnicity.",
  SELECT_FAT_ETHNICITY: "Please select your father's ethnicity.",
  SELECT_HEIGHT_1: 'Please select your height.',
  SELECT_EDUCATION: 'Please select your highest education qualification.',
  SELECT_HAIR_1: 'Please select your hair color.',
  SELECT_EYE_1: 'Please select your eye color.',
  SELECT_WEIGHT: 'Please select your weight.',
  CAPSLOCK: 'Your password must contain at least 1 uppercase character.',
  OTP_REQUIRED: 'Please enter the verification code to proceed.',
  USER_TYPE: 'Please select user type.',
  Name: 'Please enter your name.',
  ENTER_Message: 'Please enter your message.',
  MOBILE_NUMBER: 'Please enter your mobile number.',
  ALERT: 'Are you sure you want to abort? This will close your application.',
  HOLD_ON: 'Hold on!',
  CANCEL: 'Cancel',
  YES: 'Yes, Abort',
  ...
  DEACTIVATE_TEXT: `Deactivating your account will make your profile no longer visible to other users. You will also be unable to access your account's data, including matches and messages. If you are sure you want to deactivate your account, please click the "Yes, Deactivate" button below.`,
  DELETE_TEXT: `Deleting your account will remove all of your data, including your matches and messages. If you are sure you want to delete your account, please click the "Delete Account" button below.`,
  REJECT_DISCARD: 'Are you sure you do not want to send any query to Hera?',
  LOG_OUT: 'Log Out',
  ...
  REQUIRED: 'Required!',
  CARD_REQUIRED: 'Please enter your credit/debit card number.',
  CVV_REQUIRED: 'Please enter your credit/debit card CVV.',
  CVV_INVALID: 'Please enter a valid CVV.',
  CARD_INVALID: 'Please enter a valid credit/debit card number.',
  INVALID: 'Invalid!',
  NAME_REQUIRED: 'Please enter the full name of the cardholder.',
  NAME_INAVLID: 'Please enter a valid card holder’s name.',
  EXP_REQUIRED: 'Please enter a valid credit/debit card expiration date.',
  EXP_INVALID: 'Please enter a valid credit/debit card expiration date.',
  DISCARD_KYC: 'Discard KYC',
  YES_DISCARD: 'Yes, Discard',
  NOT_NOW: 'Not Now',
  DISCARD_KYC_DESC: `Are you sure you want to discard the KYC process? If you do, you will not be able to add your bank and will not be able to receive any payments.`,
  FirstName_REQUIRED: 'Please enter your first name.',
  ACCOUNTHOLDER_REQUIRED: 'Please enter the account holder name.',
  ...
  POV_REQUIRED:
    'Please upload a clear, legible image of your government-issued ID.',
  ...
  STATE_INVALID: 'Please select a valid state.',
  ...
  AMOUNT_VALID: 'Please enter a valid amount.',
  AMOUNT_POSITIVE: 'Please enter a positive amount.',
  AMOUNT_MAX:
    'The amount you entered exceeds the maximum limit of $999,999.90. Please enter a valid amount within the specified range.',
